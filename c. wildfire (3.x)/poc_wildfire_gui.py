"""
Interactive visualization of a wild fire
Click on the canvas to add orange cells to boundary of the fire
Click step to advance search, orange cells are on fire
"""
...
class WildFireGUI:
    ...
    def __init__(self, wildfire):
        ...
        self._frame = simplegui.create_frame("Interactive Grid Search demo", 
