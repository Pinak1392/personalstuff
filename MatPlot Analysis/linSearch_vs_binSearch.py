...
from BinarySearch import sortedBinSearch
...
average_times2 = sortTime(input_sizes, sortedBinSearch)

xvals = [x + 1 for x in range(0,input_sizes,100)]

plot(xvals,[[average_times,'r','linSearch'],[average_times2,'b','BinSearch']])
